...
user1 INT FOREIGN KEY REFERENCES users(uid),
user2 INT FOREIGN KEY REFERENCES users(uid),
td_tid CHAR(85) FOREIGN KEY REFERENCES transactions(td_tid)
);

CREATE TABLE messages
(
id BIGINT IDENTITY(1,1) PRIMARY KEY NOT NULL,
sender INT FOREIGN KEY REFERENCES users(uid),
